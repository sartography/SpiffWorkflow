# -*- coding: utf-8 -*-
#
# SpiffWorkflow documentation build configuration file, created by
...
#sphinx.apidoc(['-d5', '-Mef', '-o', '.', '../SpiffWorkflow'])
...
htmlhelp_basename = 'SpiffWorkflow'
...
latex_documents = [
  ('index', 'SpiffWorkflow.tex', u'SpiffWorkflow Documentation',
...
man_pages = [
    ('index', 'spiffworkflow', u'SpiffWorkflow Documentation',
     [u'Samuel Abels'], 1)
]
...
texinfo_documents = [
  ('index', 'SpiffWorkflow', u'SpiffWorkflow Documentation',
   u'Samuel Abels', 'SpiffWorkflow', 'One line description of project.',
   'Miscellaneous'),
]
